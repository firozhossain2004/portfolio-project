      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="hover:text-fuchsia-500 transition duration-300 cursor-pointer">Home</li>
            <li className="hover:text-fuchsia-500 transition duration-300 cursor-pointer">About</li>
            <li className="hover:text-fuchsia-500 transition duration-300 cursor-pointer">Projects</li>
            <li className="hover:text-fuchsia-500 transition duration-300 cursor-pointer">Contact</li>
          </ul>
        </div>
