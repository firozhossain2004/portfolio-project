...
const AboutMe = () => {
    return (
        <div>
            <h1 className='text-5xl px-2 md:px-24 py-10  font-medium'>About <span className='font-luxury italic tracking-wide'>Me</span></h1>
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="w-full xl: px-2 md:w-1/2 space-y-4 mt-3.5">
                    ...
                    <h1 className='text-4xl font font-semibold'>MD Raihan <span className='it'>
                     Hossain</span></h1>
                    <div className='text-xs text-gray-400 space-y-1.5 w-sm'>
